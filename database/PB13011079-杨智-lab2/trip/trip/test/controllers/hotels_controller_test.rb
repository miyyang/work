...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { location: @hotel.location, numavail: @hotel.numavail, numrooms: @hotel.numrooms, price: @hotel.price }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { location: @hotel.location, numavail: @hotel.numavail, numrooms: @hotel.numrooms, price: @hotel.price }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
